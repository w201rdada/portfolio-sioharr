# Reviewers Like Me {#reviewers-like-me}
#### Amazon, Review Relevancy, Lots of data, not much information
...
Amazon currently provides two review options: "All reviews " and "Verified Customer Reviews".  Amazon will provide a new feature with a link called "Reviewers Like Me".  It will help potential consumers who have reviewed Amazon products in the past navigate the confusing world of online reviewers.  The "Reviewers Like Me" link will be powered by a new algorithm developed at UC Berkeley's MIDS program.  Amazon will cluster customers who have submitted a significant amount of reviews based on multiple variables for the reviewer and product category.  Some of the variables used in the algorithm will include:       
...
4.  As this algorithm proves to be effective, it can be integrated with some of the product prioritization and alternate offers.  This will help avoid increasingly negative reviews of products from the various clusters determined in the algorithm.   
